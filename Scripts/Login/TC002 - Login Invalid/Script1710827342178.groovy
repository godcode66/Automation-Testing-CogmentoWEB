...
WebUI.setEncryptedText(findTestObject('Object Repository/Login/Page_Cogmento CRM/input_Login_password'), 'DRYm5FX+MaR6xMvfjTooZA==')

WebUI.click(findTestObject('Object Repository/Login/Page_Cogmento CRM/div_Login'))

WebUI.verifyElementText(findTestObject('Login_notification/Page_Cogmento CRM/p_Invalid login'), 'Invalid login')
